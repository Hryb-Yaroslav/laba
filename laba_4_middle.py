...
left_comp_ip = '192.168.1.10'  # ip linux
middle_comp_ip = '192.168.1.10'  # ip win
right_comp_ip = '192.168.1.10'
...
def send_left():
    global have_ball, BALL_X_SPEED, BALL_Y_SPEED
